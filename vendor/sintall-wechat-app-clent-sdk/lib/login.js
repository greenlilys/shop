    ...
    var doLogin = () => getWxLoginResult(function (wxLoginError, wxLoginResult) {
        ...
        wx.getExtConfig({
            success: function (res) {
                header[constants.WX_HEADER_APP_ID] = res.extConfig.AppId;
                header[constants.WX_HEADER_APP_MODULE] = res.extConfig.Module;
                // 请求服务器登录地址，获得会话信息
                wx.request({
